...
let root = {
  ...
  GetPhotoByDate: (req, res) => {
    ...
    return db("photos")
      ...
      .where(whereObject)
      .where("created_at", ">=", req.type.startTime + " 0:0:0")
      .where("created_at", "<=", req.type.endTime + " 23:59:59")
      .then(data => {
        for (let i in data) {
  ...
  CreatePhoto: (req, res) => {
    ...
    let sDeviceId = req.input.deviceId || "NULL";
    let sGroupId = req.input.groupId || "NULL";
    let sOrderInGroup = req.input.orderInGroup || "NULL";
