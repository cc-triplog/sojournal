...
class MapScreen extends React.Component {
  ...
  callDatabaseGPS = async () => {
    await axios({
      ...
      const http = "http://";
      const gpsImage =
        "https://cdn4.iconfinder.com/data/icons/peppyicons/512/660011-location-512.png";
  ...
  callDatabasePhotos = async () => {
    const epochToNormalStart = this.startTimeConvert(
  ...
  endTimeConvert = time => {
    ...
    if (time == undefined || time == null)
      return moment(99999999999999).format("MMM DD YY");
